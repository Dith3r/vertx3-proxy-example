...
public class UserModel {
    ...
    public static UserModel createFromJson(JsonObject object) {
        if (object != null) {
            return new UserModel(object.getString(KEY_USER_ID, NONE_VALUE), object.getString(KEY_GROUP_NAME, NONE_VALUE));
        } else {
