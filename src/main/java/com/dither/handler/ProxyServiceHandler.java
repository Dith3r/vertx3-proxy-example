 ...
 */
public class ProxyServiceHandler implements ProxyHandler {
    /**
    ...
    public void handle(RoutingContext context) {
        try {
            ...
            HttpClientRequest proxyRequest = client.request(clientRequest.method(), host.getInteger("port"), host.getString("host"), clientRequest.uri(), innerRequest -> {
